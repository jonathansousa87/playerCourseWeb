...
- **Player + lesson groups** — vídeo (MP4/WEBM/MKV/M3U8/TS), PDF, HTML, Markdown. Arquivos de mesmo prefixo viram uma linha do tempo de etapas: Pré-quiz · Vídeo · Podcast · Resumo · Pausa · Quiz · Flashcards · Prática · Meu Resumo. Sidebar deslizante, layout de 1 a 5 colunas, atalhos de teclado.
