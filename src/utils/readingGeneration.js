  ...
  const results = await generateReadingBatch({
    ...
    onProgress: (ev) => {
      ...
      switch (ev.type) {
        ...
        case "ocr": onProgress({ kind: "module-ocr", ...tag, status: ev.status, ocrPhase: ev.ocrPhase, video: ev.video, videoIndex: ev.videoIndex, videoTotal: ev.videoTotal, vocabulary: ev.vocabulary, diagrams: ev.diagrams, error: ev.error }); break;
